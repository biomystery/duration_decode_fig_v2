...
# rescaled here
colnames(pd.rnaseq)
pd.rnaseq.bak <- pd.rnaseq 
pd.rnaseq[,1:(ncol(pd.rnaseq)/2)] <- pd.rnaseq[,1:(ncol(pd.rnaseq)/2)]/apply(pd.rnaseq[,1:(ncol(pd.rnaseq)/2)],1,max)
pd.rnaseq[,1:(ncol(pd.rnaseq)/2)] <- pd.rnaseq[,1:(ncol(pd.rnaseq)/2)]/apply(pd.rnaseq[,((ncol(pd.rnaseq)/2)+1):ncol(pd.rnaseq)],1,max)
all(apply(pd.rnaseq[,((ncol(pd.rnaseq)/2)+1):ncol(pd.rnaseq)],1,max)==1)
